...
-- =============================================================================
-- Agregado despues (23/09/2026): Sonic T16, confirmado por Javier.
-- Polar y polinam estaban cruzados. Ya aplicado; las dos lineas tambien quedaron
-- en respaldo_recetas_20260923.
-- =============================================================================
-- update recetas_lineas set cantidad = 0.049 where id = '0e0d1c69-a4f3-47a3-b801-2f74bef96736' and cantidad = 0; -- PRM0157 T16 POLAR AMARILLO ORO
-- update recetas_lineas set cantidad = 0.35  where id = '746bf212-f136-4211-ba9f-3de51767f06e' and cantidad = 0; -- PRM0157 T16 POLINAM BRILLOSO AMARILLO ORO
