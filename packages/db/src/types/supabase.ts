  ...
  public: {
    Tables: {
      ...
      areas_costos_mensuales: {
        ...
        Relationships: [
          {
            foreignKeyName: "areas_costos_mensuales_area_id_fkey"
            columns: ["area_id"]
            isOneToOne: false
      ...
      areas_costos_parametros: {
        Row: {
          area_id: string
          minutos_override: number | null
          notas: string | null
        ...
        Relationships: [
          {
            foreignKeyName: "areas_costos_parametros_area_id_fkey"
            columns: ["area_id"]
            isOneToOne: false
            referencedRelation: "areas_produccion"
            referencedColumns: ["id"]
      ...
      areas_valor_minuto_historial: {
        ...
        Relationships: [
          {
            foreignKeyName: "areas_valor_minuto_historial_area_id_fkey"
            columns: ["area_id"]
            isOneToOne: false
            referencedRelation: "areas_produccion"
            referencedColumns: ["id"]
      ...
      caja_chica_movimientos: {
        ...
        Relationships: [
          ...
          {
            foreignKeyName: "caja_chica_movimientos_categoria_id_fkey"
            columns: ["categoria_id"]
            isOneToOne: false
            referencedRelation: "caja_chica_categorias"
            referencedColumns: ["id"]
          },
          {
      ...
      cajas_cierres_parciales: {
        ...
        Relationships: [
          {
            foreignKeyName: "cajas_cierres_parciales_caja_id_fkey"
            columns: ["caja_id"]
            isOneToOne: false
            referencedRelation: "cajas"
            referencedColumns: ["id"]
          ...
          {
            foreignKeyName: "cajas_cierres_parciales_sesion_id_fkey"
            columns: ["sesion_id"]
            isOneToOne: false
            referencedRelation: "cajas_sesiones"
            referencedColumns: ["id"]
      ...
      carritos: {
        ...
        Relationships: [
          ...
          },
          {
            ...
            columns: ["cliente_id"]
            isOneToOne: false
            referencedRelation: "v_clientes_saldos"
      ...
      catalogo_pasos_operativos: {
        ...
        Relationships: [
          {
            foreignKeyName: "catalogo_pasos_operativos_area_id_fkey"
            columns: ["area_id"]
            isOneToOne: false
            referencedRelation: "areas_produccion"
            referencedColumns: ["id"]
      ...
      clientes_adelantos: {
        ...
        Relationships: [
          {
            foreignKeyName: "clientes_adelantos_caja_sesion_id_fkey"
          ...
          {
            foreignKeyName: "clientes_adelantos_cliente_id_fkey"
            columns: ["cliente_id"]
            isOneToOne: false
            referencedRelation: "clientes"
            referencedColumns: ["id"]
          ...
          {
            foreignKeyName: "clientes_adelantos_venta_id_fkey"
            columns: ["venta_id"]
            isOneToOne: false
            referencedRelation: "v_ventas_exportacion"
            referencedColumns: ["id"]
          },
          {
            foreignKeyName: "clientes_adelantos_venta_id_fkey"
      ...
      cola_impresion: {
        ...
        Relationships: [
          {
            foreignKeyName: "cola_impresion_comprobante_id_fkey"
          ...
          {
            foreignKeyName: "cola_impresion_equipo_id_fkey"
            columns: ["equipo_id"]
            isOneToOne: false
            referencedRelation: "equipos_impresion"
            referencedColumns: ["id"]
          },
        ]
      }
      ...
      comprobantes: {
        Row: {
          cdr_url: string | null
          cliente_id: string | null
          codigo_operacion_sunat: string | null
          created_at: string | null
          ...
          sunat_intentos: number
          sunat_mensaje: string | null
          sunat_proximo_intento: string | null
          sunat_ultimo_error: string | null
        ...
        Relationships: [
          ...
          {
            foreignKeyName: "comprobantes_pais_destino_iso_fkey"
            columns: ["pais_destino_iso"]
            isOneToOne: false
            referencedRelation: "paises_exportacion"
            referencedColumns: ["codigo_iso"]
          },
          {
      ...
      cotizaciones_lineas: {
        ...
        Relationships: [
          {
            foreignKeyName: "cotizaciones_lineas_cotizacion_id_fkey"
          ...
          {
            foreignKeyName: "cotizaciones_lineas_variante_id_fkey"
            columns: ["variante_id"]
            isOneToOne: false
            referencedRelation: "productos_variantes"
            referencedColumns: ["id"]
      ...
      empresa: {
        Row: {
          ...
          email: string | null
          escalon_industrial_desde: number
          escalon_mayorista_desde: number
          escalones_activos: boolean
          id: string
          idioma: string
          igv_porcentaje: number
          logo_url: string | null
          max_imagenes_producto: number
          moneda_base: string
          nombre_comercial: string | null
      ...
      equipos_impresion: {
        ...
        Relationships: [
          {
            foreignKeyName: "equipos_impresion_almacen_id_fkey"
            columns: ["almacen_id"]
            isOneToOne: false
            referencedRelation: "almacenes"
            referencedColumns: ["id"]
      ...
      fichas_imagenes: {
        ...
        Relationships: [
          {
            foreignKeyName: "fichas_imagenes_ficha_id_fkey"
            columns: ["ficha_id"]
            isOneToOne: false
            referencedRelation: "productos_fichas_tecnicas"
            referencedColumns: ["id"]
          },
        ]
      }
      fichas_links_publicos: {
        Row: {
          activo: boolean
          creado_por: string | null
          created_at: string | null
        ...
        Relationships: [
          {
            foreignKeyName: "fichas_links_publicos_ficha_id_fkey"
            columns: ["ficha_id"]
            isOneToOne: false
            referencedRelation: "productos_fichas_tecnicas"
            referencedColumns: ["id"]
      ...
      fichas_medidas: {
        ...
        Relationships: [
          {
            foreignKeyName: "fichas_medidas_ficha_id_fkey"
            columns: ["ficha_id"]
            isOneToOne: false
            referencedRelation: "productos_fichas_tecnicas"
            referencedColumns: ["id"]
      ...
      fichas_medidas_valores: {
        ...
        Relationships: [
          {
            foreignKeyName: "fichas_medidas_valores_medida_id_fkey"
            columns: ["medida_id"]
            isOneToOne: false
            referencedRelation: "fichas_medidas"
            referencedColumns: ["id"]
          },
        ]
      }
      fichas_piezas_corte: {
        ...
        Relationships: [
          {
            foreignKeyName: "fichas_piezas_corte_ficha_id_fkey"
            columns: ["ficha_id"]
            isOneToOne: false
            referencedRelation: "productos_fichas_tecnicas"
            referencedColumns: ["id"]
      ...
      importaciones: {
        Row: {
          ...
          cif_prorrateado_por: string | null
          cif_total_distribuido: number | null
      ...
      oc_recepciones_lineas: {
        Row: {
          ...
          costo_adicional_prorrateado: number | null
          costo_unitario: number | null
          costo_unitario_cif: number | null
          fecha_vencimiento: string | null
          id: string
          material_id: string | null
      ...
      ot_corte: {
        Row: {
          ...
          autorizacion_solicitada_por: string | null
      ...
      ot_corte_tiempos: {
        ...
        Relationships: [
          {
            foreignKeyName: "ot_corte_tiempos_corte_id_fkey"
            columns: ["corte_id"]
            isOneToOne: false
            referencedRelation: "ot_corte"
            referencedColumns: ["id"]
          ...
          {
            foreignKeyName: "ot_corte_tiempos_material_id_fkey"
            columns: ["material_id"]
            isOneToOne: false
            referencedRelation: "materiales"
            referencedColumns: ["id"]
          ...
          {
            foreignKeyName: "ot_corte_tiempos_responsable_operario_id_fkey"
            columns: ["responsable_operario_id"]
            isOneToOne: false
            referencedRelation: "operarios"
            referencedColumns: ["id"]
      ...
      ot_registros_tiempo: {
        ...
        Relationships: [
          {
            foreignKeyName: "ot_registros_tiempo_operario_id_fkey"
            columns: ["operario_id"]
            isOneToOne: false
            referencedRelation: "operarios"
            referencedColumns: ["id"]
          ...
          {
            foreignKeyName: "ot_registros_tiempo_ot_id_fkey"
            columns: ["ot_id"]
            isOneToOne: false
            referencedRelation: "ot"
            referencedColumns: ["id"]
          ...
          {
            foreignKeyName: "ot_registros_tiempo_proceso_id_fkey"
            columns: ["proceso_id"]
            isOneToOne: false
            referencedRelation: "productos_procesos"
            referencedColumns: ["id"]
          },
        ]
      }
      ot_tiempos_reales: {
        ...
        Relationships: [
          {
            foreignKeyName: "ot_tiempos_reales_ot_id_fkey"
            columns: ["ot_id"]
            isOneToOne: false
            referencedRelation: "ot"
            referencedColumns: ["id"]
          ...
          {
            foreignKeyName: "ot_tiempos_reales_proceso_id_fkey"
            columns: ["proceso_id"]
            isOneToOne: false
            referencedRelation: "productos_procesos"
            referencedColumns: ["id"]
      ...
      pagos_talleres: {
        Row: {
          ...
          fecha: string
          id: string
          medio_pago: Database["public"]["Enums"]["medio_pago_taller"]
          monto: number
        ...
        Relationships: [
          {
            foreignKeyName: "pagos_talleres_os_id_fkey"
            columns: ["os_id"]
            isOneToOne: false
            referencedRelation: "ordenes_servicio"
            referencedColumns: ["id"]
          ...
          {
            foreignKeyName: "pagos_talleres_taller_id_fkey"
            columns: ["taller_id"]
            isOneToOne: false
            referencedRelation: "talleres"
            referencedColumns: ["id"]
      ...
      plan_maestro: {
        Row: {
          ...
          aprobacion_solicitada_por: string | null
          codigo: string
          creado_por: string | null
          created_at: string | null
          estado: string | null
        ...
        Relationships: [
          {
            foreignKeyName: "plan_maestro_aprobacion_solicitada_por_fkey"
            columns: ["aprobacion_solicitada_por"]
            isOneToOne: false
      ...
      productos: {
        ...
        Relationships: [
          ...
          },
          {
            ...
            columns: ["familia_id"]
            isOneToOne: false
            referencedRelation: "productos_familias"
            referencedColumns: ["id"]
          },
          {
      ...
      productos_categorias_extra: {
        ...
        Relationships: [
          {
            foreignKeyName: "productos_categorias_extra_categoria_id_fkey"
            columns: ["categoria_id"]
            isOneToOne: false
            referencedRelation: "categorias"
            referencedColumns: ["id"]
          ...
          {
            foreignKeyName: "productos_categorias_extra_producto_id_fkey"
            columns: ["producto_id"]
            isOneToOne: false
            referencedRelation: "productos"
            referencedColumns: ["id"]
      ...
      productos_fichas_tecnicas: {
        ...
        Relationships: [
          {
            foreignKeyName: "productos_fichas_tecnicas_producto_id_fkey"
            columns: ["producto_id"]
            isOneToOne: false
            referencedRelation: "productos"
            referencedColumns: ["id"]
      ...
      solicitudes_os: {
        ...
        Relationships: [
          {
            foreignKeyName: "solicitudes_os_os_generada_id_fkey"
            columns: ["os_generada_id"]
            isOneToOne: false
            referencedRelation: "ordenes_servicio"
            referencedColumns: ["id"]
          },
          {
            foreignKeyName: "solicitudes_os_ot_id_fkey"
            columns: ["ot_id"]
            isOneToOne: false
            referencedRelation: "ot"
            referencedColumns: ["id"]
          ...
          {
            foreignKeyName: "solicitudes_os_taller_id_fkey"
            columns: ["taller_id"]
            isOneToOne: false
            referencedRelation: "talleres"
            referencedColumns: ["id"]
      ...
      sunat_resumenes: {
        ...
        Relationships: [
          {
            foreignKeyName: "sunat_resumenes_empresa_id_fkey"
            columns: ["empresa_id"]
            isOneToOne: false
            referencedRelation: "empresa"
            referencedColumns: ["id"]
      ...
      tarifas_servicios: {
        ...
        Relationships: [
          {
            foreignKeyName: "tarifas_servicios_producto_id_fkey"
            columns: ["producto_id"]
            isOneToOne: false
            referencedRelation: "productos"
            referencedColumns: ["id"]
      ...
      tickets_operacion: {
        ...
        Relationships: [
          ...
          {
            foreignKeyName: "tickets_operacion_os_id_fkey"
            columns: ["os_id"]
            isOneToOne: false
            referencedRelation: "ordenes_servicio"
            referencedColumns: ["id"]
      ...
      ventas: {
        ...
        Relationships: [
          ...
          {
            foreignKeyName: "ventas_pais_destino_iso_fkey"
            columns: ["pais_destino_iso"]
            isOneToOne: false
            referencedRelation: "paises_exportacion"
            referencedColumns: ["codigo_iso"]
    ...
    Views: {
      ...
      v_pagos_talleres_mes: {
        Row: {
          cantidad_pagos: number | null
          medios_usados: string[] | null
          mes: string | null
          taller_id: string | null
    ...
    Functions: {
      close_corte_atomic: { Args: { p_corte_id: string }; Returns: Json }
      close_ot_atomic: {
        Args: { p_almacen_destino: string; p_ot_id: string; p_user_id: string }
        Returns: Json
      }
      costeo_variante: {
      ...
      limpiar_cola_impresion: { Args: never; Returns: number }
      log_audit: {
        Args: {
          p_accion: string
          p_contexto?: Json
      ...
      prorratear_cif_importacion: { Args: { p_imp_id: string }; Returns: Json }
      puede_acceder_almacen: { Args: { p_almacen: string }; Returns: boolean }
      recalcular_calificacion_taller: {
      ...
      sync_ot_cortada: {
        Args: { p_ot_id: string; p_producto_id: string }
        Returns: number
      }
      tiene_algun_rol: {
    ...
    Enums: {
      canal_venta: "POS" | "WEB" | "B2B" | "WHATSAPP" | "REDES" | "EXPORTACION"
