  ...
  return (
    <PageShell title="Configuración" description="Datos de la empresa, parámetros del sistema, integraciones.">
      <div className="grid gap-3 sm:grid-cols-2 lg:grid-cols-3">
        ...
        <Link href="/configuracion/cuentas-bancarias">
          <Card className="group cursor-pointer transition hover:-translate-y-0.5 hover:border-happy-300 hover:shadow-md">
            <CardContent className="flex items-center gap-3 p-4">
              <div className="flex h-10 w-10 items-center justify-center rounded-lg bg-happy-50 text-happy-600 transition group-hover:bg-happy-500 group-hover:text-white">
              ...
              <div className="flex-1">
                <p className="font-display text-sm font-semibold text-corp-900">Cuentas bancarias / medios de pago</p>
                <p className="text-xs text-slate-500">BCP HAPPYS · BCP JAVIER · INTERBANK HAPPYS · INTERBANK JAVIER · BBVA · YAPE/PLIN</p>
              </div>
            </CardContent>
          </Card>
        </Link>
        <Link href="/configuracion/catalogo-procesos">
          <Card className="group cursor-pointer transition hover:-translate-y-0.5 hover:border-happy-300 hover:shadow-md">
            <CardContent className="flex items-center gap-3 p-4">
              <div className="flex h-10 w-10 items-center justify-center rounded-lg bg-happy-50 text-happy-600 transition group-hover:bg-happy-500 group-hover:text-white">
              ...
              <div className="flex-1">
                <p className="font-display text-sm font-semibold text-corp-900">Catálogo de pasos operativos</p>
                <p className="text-xs text-slate-500">Pasos concretos dentro de cada área (DESEMBOLSADO, LIMPIEZA, DELANTERO IZQ…)</p>
              </div>
            </CardContent>
          </Card>
        </Link>
        ...
        <Link href="/configuracion/impresion">
          <Card className="group cursor-pointer transition hover:-translate-y-0.5 hover:border-happy-300 hover:shadow-md">
            <CardContent className="flex items-center gap-3 p-4">
              <div className="flex h-10 w-10 items-center justify-center rounded-lg bg-happy-50 text-happy-600 transition group-hover:bg-happy-500 group-hover:text-white">
              ...
              <div className="flex-1">
                <p className="font-display text-sm font-semibold text-corp-900">Impresión de tickets</p>
                <p className="text-xs text-slate-500">Computadoras con ticketera, corte y formato</p>
              </div>
            </CardContent>
          </Card>
        </Link>
